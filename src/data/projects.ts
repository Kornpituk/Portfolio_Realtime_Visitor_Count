...
export const projectsMockData: Project[] = [
  ...
  {
    id: 3,
    title: "WMS NUTRIX PUBLIC COMPANY LIMITED ",
    description:
      "Frontend VueJs,Authentication JWT token, planner, receviep, shipment, and admin dashboard.",
    images: [
      "/project/nutrix/10.png",
    ...
    overview: {
      th: "โปรเจคนี้เป็น Web-based Warehouse Management System (WMS) ที่พัฒนาขึ้นเพื่อทดแทนกระบวนการทำงานเดิมซึ่งพึ่งพาเอกสาร Excel และการกรอกข้อมูลด้วยมือ ระบบถูกออกแบบมาเพื่อรองรับการทำงานของหลายแผนก เช่น Warehouse, Production, Quality Control และ Logistics ภายในแพลตฟอร์มเดียว\n\nฝั่ง Frontend ถูกพัฒนาเพื่อรองรับ Workflow ที่ซับซ้อน, Role-based Access Control, และ Approval Process หลายขั้นตอน โดยแต่ละเมนูจะถูกออกแบบให้สอดคล้องกับกระบวนการทำงานจริงของหน้างาน (Operational Flow)",
      en: "This project is a web-based Warehouse Management System (WMS) designed to replace manual, Excel-based workflows previously used across multiple departments. The system supports cross-functional operations including Warehouse, Production, Quality Control, and Logistics within a single unified platform.\n\nOn the frontend side, the application is built to handle complex workflows, role-based access control, and multi-step approval processes, while closely aligning with real-world operational flows.",
    },
    // Project Goals
    goals: {
      th: [
    ...
    videoUrl: "",
    status: "Completed phase 1, maintenance and Updated Phase 2",
    teamSize: "4",
    role: "Frontend Developer",
    date: "Jan 2023 - Aug 2023",
    githubUrl: "",
    liveUrl: "https://sktdev.easetrackwms.com/login",
    image: "/project/nutrix/1.png",
    impact:
      "Digitized warehouse operations, eliminating paper-based processes and enabling real-time workflow tracking across multiple departments.",
